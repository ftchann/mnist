...
class neuronalesNetzwerk:
    ...
    def __init__(self, eingabeneuronen, verstecketeneuronen, ausgabeneuronen, learnrate, verstecktelayers):
        ...
        if self.vlayer == 1:
            self.ge_va = np.random.normal(0.0,pow(self.aneuron, -0.5),(self.aneuron, self.vneuron1))
    ...
    def trainieren(self, inputs_list, ziel_liste,):
        ...
        if self.vlayer == 0:
            ...
            print("V1_outputs:",np.shape(versteckte_1_outputs))
            #Verstecktes Layer 2
            ...
            print("V2_outputs:",np.shape(versteckte_2_outputs))
            #Verstecktes Layer 3
            ...
            print("V3_outputs:",np.shape(versteckte_3_outputs))
            #Verstecktes Layer 4
            ...
            print("V4_outputs:",np.shape(versteckte_4_outputs))
            #Verstecktes Layer 5
            ...
            print("V5_outputs:",np.shape(versteckte_5_outputs))
            #Ausgabe Layer
            ausgabe_inputs = np.dot(self.ge_va, versteckte_5_outputs)
            ausgabe_outputs = self.aktivierungsfunktion(ausgabe_inputs)
            print("A_outputs:",np.shape(ausgabe_outputs))
            
            ausgabe_fehler = ziele - ausgabe_outputs
            print("A_fehler:",np.shape(ausgabe_fehler))
            versteckte_5_fehler = np.dot(self.ge_va.T, ausgabe_fehler)
            print("V5_fehler:",np.shape(versteckte_5_fehler))
            versteckte_4_fehler = np.dot(self.ge_v5.T, versteckte_5_fehler)
            print("V4_fehler:",np.shape(versteckte_4_fehler))
            versteckte_3_fehler = np.dot(self.ge_v4.T, versteckte_4_fehler)
            print("V3_fehler:",np.shape(versteckte_3_fehler))
            versteckte_2_fehler = np.dot(self.ge_v3.T, versteckte_3_fehler)
            print("V2_fehler:",np.shape(versteckte_2_fehler))
            versteckte_1_fehler = np.dot(self.ge_v2.T, versteckte_2_fehler)
            print("V1_fehler:",np.shape(versteckte_1_fehler))
            ...
            c=self.lr * np.dot((versteckte_4_fehler * versteckte_4_outputs * (1-versteckte_4_outputs)), versteckte_3_outputs.T)
            d=self.lr * np.dot((versteckte_3_fehler * versteckte_3_outputs * (1-versteckte_3_outputs)), versteckte_2_outputs.T)
            e=self.lr * np.dot((versteckte_2_fehler * versteckte_2_outputs * (1-versteckte_2_outputs)), versteckte_1_outputs.T)
            f=self.lr * np.dot((versteckte_1_fehler * versteckte_1_outputs * (1-versteckte_1_outputs)), inputs.T)
            print("ge_va:", np.shape(a))
            print("ge_v5:", np.shape(b))
            print("ge_v4:", np.shape(c))
